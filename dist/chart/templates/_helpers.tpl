...
*/}}
{{- define "sops-secret-operator.name" -}}
...
*/}}
{{- define "sops-secret-operator.fullname" -}}
...
*/}}
{{- define "sops-secret-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "sops-secret-operator.resourceName" -}}
{{- $fullname := include "sops-secret-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "sops-secret-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "sops-secret-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
