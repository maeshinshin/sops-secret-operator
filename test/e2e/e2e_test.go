...
import (
	...
	"github.com/maeshinshin/sops-secret-operator/test/utils"
)

// namespace where the project is deployed in
const namespace = "sops-secret-operator-system"

// serviceAccountName created for the project
const serviceAccountName = "sops-secret-operator-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "sops-secret-operator-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "sops-secret-operator-metrics-binding"
